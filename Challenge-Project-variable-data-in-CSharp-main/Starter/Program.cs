...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogCharacteristicArray = new string[10];
            ...
            while (dogCharacteristic == "")
            {
                ...
                if (readResult != null)
                {
                    ...
                    //Console.WriteLine(String.Join(",", dogCharacteristicArray));  //used to print the array seperates each element by ,
                }
            }
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string element in dogCharacteristicArray)
                    {
                        if (dogDescription.Contains(element))
                        {
                            // #3b update message to reflect term 
                            // #3c set a flag "this dog" is a match
                            Console.WriteLine($"Our dog {ourAnimals[i, 3]} is a match for your search for {element}!");
                            noMatchesDog = false;
                        }
